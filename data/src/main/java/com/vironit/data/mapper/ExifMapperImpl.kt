...
class ExifMapperImpl: Mapper<ExifEntity, Exif> {
    override fun fromEntity(from: ExifEntity): Exif {
        return Exif(from.make, from.model, from.exposure, from.aperture,
        from.focal, from.iso)
    }

    override fun toEntity(from: Exif): ExifEntity {
        return ExifEntity(from.make, from.model, from.exposure, from.aperture,
            from.focal, from.iso)
    }
}